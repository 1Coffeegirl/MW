        ...
        <div class="foto-container">
            ...
            <div class="copyright">
               <?php 
                  ...
                  ?></span> - <?php     
                      printf( __( 'WordPress Theme : %1$s by %2$s', 'fotography' ), 'Fotography', '<a href="'.esc_url('https://accesspressthemes.com/wordpress-themes/fotography/' ).'">AccessPress Themes</a>'  ); 
                  ?>
            </div>
        </div>
    </div><!-- .site-info -->
